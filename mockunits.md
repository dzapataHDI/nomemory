...
Each main `MockNeat` object is composed by different implementations of [[MockUnit<T>|#mockunit-t-stream]], `MockUnitInt`, `MockUnitLong`, `MockUnitDouble`, `MockUnitString`, `MockUnitDays`, `MockUnitMonths`, `MockUnitLocalDate` interfaces.
