...
Each main `MockNeat` object is composed by different implementations of [`MockUnit<T>`](#MockUnit), `MockUnitInt`, `MockUnitLong`, `MockUnitDouble`, `MockUnitString`, `MockUnitDays`, `MockUnitMonths`, `MockUnitLocalDate` interfaces.
